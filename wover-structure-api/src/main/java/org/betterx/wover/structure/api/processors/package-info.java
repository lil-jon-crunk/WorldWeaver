 ...
 * <p>
 * {@link org.betterx.wover.structure.api.processors.StructureProcessorManager} creates a
 * {@link org.betterx.wover.structure.api.processors.StructureProcessorKey} — a wrapper around a
 * {@link net.minecraft.resources.ResourceKey} for the processor list. Call
 * {@link org.betterx.wover.structure.api.processors.StructureProcessorKey#bootstrap(net.minecraft.data.worldgen.BootstrapContext)}
 * to obtain a {@link org.betterx.wover.structure.api.processors.StructureProcessorBuilder} and register the
 * list:
