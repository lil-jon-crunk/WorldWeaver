 ...
 * {@link org.betterx.wover.biome.api.BiomeManager#vanilla(Identifier)}), or {@link #wrappedKey(ResourceKey)}
...
public interface WoverBiomeBuilder<B extends BiomeBuilder<B>> {
     ...
     * <p>
     * Mirrors {@link org.betterx.wover.biome.api.BiomeManager#vanilla(Identifier)}, but with the
