...
public class ModelProviderMixin {
    ...
    private boolean wover_notExcluded(Map instance, Object o, Operation<Boolean> original) {
        return original.call(instance, o) || ModelProviderExclusions.isExcluded((Block) o);
    }
}
