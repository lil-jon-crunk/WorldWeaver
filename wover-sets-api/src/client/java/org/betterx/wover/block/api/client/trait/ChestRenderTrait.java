...
/**
 * A {@link BlockTrait} attaching the client-side render {@link SpriteId}s (single/left/right chest halves) a
...
public interface ChestRenderTrait extends BlockTrait<Block, ChestRenderTrait> {
     ...
     */
    record ChestMaterialSet(SpriteId single, SpriteId left, SpriteId right) {
    }
