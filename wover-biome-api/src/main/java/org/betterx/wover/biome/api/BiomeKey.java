 ...
 * <p>
 * Instances are created through {@link org.betterx.wover.biome.api.BiomeManager#vanilla(Identifier)}
 * (a fully custom, vanilla-style Biome) or
 * {@link org.betterx.wover.biome.api.BiomeManager#wrapped(ResourceKey)} (attaching {@link BiomeData} to an
