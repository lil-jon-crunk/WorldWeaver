 ...
 * <p>
 * Instances are normally not created directly; use {@link org.betterx.wover.biome.api.builder.BiomeBuilder}
 * (through {@link org.betterx.wover.biome.api.BiomeManager#vanilla(net.minecraft.resources.Identifier)}
 * or {@link org.betterx.wover.biome.api.BiomeManager#wrapped(ResourceKey)}) instead. Once the world is
 * loaded, look up the {@link BiomeData} for a Biome using
 * {@link org.betterx.wover.biome.api.BiomeManager#biomeData(Identifier)} or
 * {@link org.betterx.wover.biome.api.BiomeManager#biomeDataForHolder(Holder)}.
 */
